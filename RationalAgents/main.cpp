...
int _tmain(int argc, _TCHAR* argv[])
{
    ...
    while (true)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            for (auto& p : prods)
            {
                p->optimizeProductionAndPrice(solver, market);
            }
        }
