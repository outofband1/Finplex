...
public:
    ...
    const std::shared_ptr<Commodity>& getCommodity(const std::string& id) const;
...
private:
    ...
    const std::string commodityDefFilename_ = "C:/Projects/finplex/RationalAgents/RationalAgents/def_commodity.xml";
